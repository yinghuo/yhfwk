...
CREATE TABLE `fqdjb` (
  ...
  `PZSJ` datetime DEFAULT NULL COMMENT '配种时间',
  `PZSJ1` datetime DEFAULT NULL COMMENT '配种结束时间',
...
-- Records of fqdjb
-- ----------------------------
INSERT INTO `fqdjb` VALUES ('3715e636-094a-4389-9f65-79ae683e713a', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'ec155fa0-2b05-46b1-91ed-eafa64af475c', '2016-03-22 23:22:10', '2016-03-23 07:22:10', '2016-03-23 11:22:10', '0', '1', null, '', '0', null, null, '0');
INSERT INTO `fqdjb` VALUES ('49ded95b-3e50-4d3a-8670-2b7263b4273d', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'ec155fa0-2b05-46b1-91ed-eafa64af475c', '2016-03-22 01:00:00', '2016-03-22 09:00:00', '2016-03-22 13:00:00', '0', '1', null, '', '0', null, null, '0');
INSERT INTO `fqdjb` VALUES ('4692e404-53a9-4e69-87ba-9b48fb852bdb', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2016-04-06 16:16:58', '2016-04-07 00:16:58', '2016-04-07 04:16:58', '0', '0', '张三', '李四', '1', null, '', '0');

-- ----------------------------
-- Table structure for `fqjbkzxx`
-- ----------------------------
DROP TABLE IF EXISTS `fqjbkzxx`;
CREATE TABLE `fqjbkzxx` (
  `JBKZID` varchar(36) NOT NULL,
  `NCBH` varchar(36) DEFAULT NULL,
  `JBQBH` varchar(36) DEFAULT NULL,
  `JBSC` char(1) DEFAULT NULL,
  `CFBZ` char(1) DEFAULT NULL,
  PRIMARY KEY (`JBKZID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
-- Table structure for `fqjbxx2`
-- ----------------------------
DROP TABLE IF EXISTS `fqjbxx2`;
CREATE TABLE `fqjbxx2` (
  `XH` varchar(36) NOT NULL,
  `JBQBH` varchar(36) DEFAULT NULL,
  `NCBH` varchar(36) DEFAULT NULL,
  `KZQBH` varchar(128) DEFAULT NULL,
...
CREATE TABLE `fqtsxx` (
  ...
  `fqid` varchar(36) DEFAULT NULL COMMENT '发情信息ID',
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of fqtsxx
-- ----------------------------
INSERT INTO `fqtsxx` VALUES ('1', null, 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'ec155fa0-2b05-46b1-91ed-eafa64af475c', '1', 'XXXX2016-03-22 23:22:10YYYYY', '1', '', null, null, '3715e636-094a-4389-9f65-79ae683e713a');
INSERT INTO `fqtsxx` VALUES ('2', null, 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'ec155fa0-2b05-46b1-91ed-eafa64af475c', '1', 'XXXX2016-03-22 01:00:00YYYYY', '1', '', null, null, '49ded95b-3e50-4d3a-8670-2b7263b4273d');
INSERT INTO `fqtsxx` VALUES ('3', null, 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'ec155fa0-2b05-46b1-91ed-eafa64af475c', '1', 'XXXX2016-03-22 01:00:00YYYYY', '0', null, null, null, null);

-- ----------------------------
-- Table structure for `fqydsjxx`
-- ----------------------------
DROP TABLE IF EXISTS `fqydsjxx`;
CREATE TABLE `fqydsjxx` (
  `XH` varchar(36) NOT NULL,
  `NCBH` varchar(36) DEFAULT NULL,
  `JBQBH` varchar(36) DEFAULT NULL,
  `NZBH` varchar(36) DEFAULT NULL,
  `JLRQ` date DEFAULT NULL,
  `JLBS0` int(11) DEFAULT NULL,
  `JLBS1` int(11) DEFAULT NULL,
  `JLBS2` int(11) DEFAULT NULL,
  `JLBS3` int(11) DEFAULT NULL,
  `JLBS4` int(11) DEFAULT NULL,
  `JLBS5` int(11) DEFAULT NULL,
  `JLBS6` int(11) DEFAULT NULL,
  `JLBS7` int(11) DEFAULT NULL,
  `JLBS8` int(11) DEFAULT NULL,
  `JLBS9` int(11) DEFAULT NULL,
  `JLBS10` int(11) DEFAULT NULL,
  `JLBS11` int(11) DEFAULT NULL,
  `JLBS12` int(11) DEFAULT NULL,
  `JLBS13` int(11) DEFAULT NULL,
  `JLBS14` int(11) DEFAULT NULL,
  `JLBS15` int(11) DEFAULT NULL,
  `JLBS16` int(11) DEFAULT NULL,
  `JLBS17` int(11) DEFAULT NULL,
  `JLBS18` int(11) DEFAULT NULL,
  `JLBS19` int(11) DEFAULT NULL,
  `JLBS20` int(11) DEFAULT NULL,
  `JLBS21` int(11) DEFAULT NULL,
  `JLBS22` int(11) DEFAULT NULL,
  `JLBS23` int(11) DEFAULT NULL,
  `PJBS0` int(11) DEFAULT NULL,
  `PJBS1` int(11) DEFAULT NULL,
  `PJBS2` int(11) DEFAULT NULL,
  `PJBS3` int(11) DEFAULT NULL,
  `PJBS4` int(11) DEFAULT NULL,
  `PJBS5` int(11) DEFAULT NULL,
  `PJBS6` int(11) DEFAULT NULL,
  `PJBS7` int(11) DEFAULT NULL,
  `PJBS8` int(11) DEFAULT NULL,
  `PJBS9` int(11) DEFAULT NULL,
  `PJBS10` int(11) DEFAULT NULL,
  `PJBS11` int(11) DEFAULT NULL,
  `PJBS12` int(11) DEFAULT NULL,
  `PJBS13` int(11) DEFAULT NULL,
  `PJBS14` int(11) DEFAULT NULL,
  `PJBS15` int(11) DEFAULT NULL,
  `PJBS16` int(11) DEFAULT NULL,
  `PJBS17` int(11) DEFAULT NULL,
  `PJBS18` int(11) DEFAULT NULL,
  `PJBS19` int(11) DEFAULT NULL,
  `PJBS20` int(11) DEFAULT NULL,
  `PJBS21` int(11) DEFAULT NULL,
  `PJBS22` int(11) DEFAULT NULL,
  `PJBS23` int(11) DEFAULT NULL,
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `gtcndjb` (
  ...
  `NCBH` varchar(36) DEFAULT NULL,
  `NZBH` varchar(36) DEFAULT NULL,
  `JNRQ` date DEFAULT NULL,
  `BC` varchar(16) DEFAULT NULL,
  `SCL` decimal(10,2) DEFAULT NULL COMMENT '0',
  `XCL` decimal(10,2) DEFAULT NULL COMMENT '0',
  `WCL` decimal(10,2) DEFAULT NULL COMMENT '0',
  `RC` decimal(10,2) DEFAULT '0.00' COMMENT '日产',
  `SRC` decimal(10,2) DEFAULT '0.00' COMMENT '上日产',
  `CE` decimal(10,2) DEFAULT '0.00' COMMENT '差额',
  `BZ` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of gtcndjb
-- ----------------------------
INSERT INTO `gtcndjb` VALUES ('4164bdef-4bca-4b64-9690-249e04ea1177', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2015-06-29', null, '1.00', '0.00', '0.00', '1.00', '0.00', '0.00', '');
INSERT INTO `gtcndjb` VALUES ('1be54e94-8a3e-4027-aa69-f8ee6fb81ecb', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2015-10-07', null, '1.00', '2.00', '3.00', '6.00', '0.00', '0.00', '');
INSERT INTO `gtcndjb` VALUES ('47db281d-589f-442a-9a19-d27df04752fe', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2015-10-08', null, '3.00', '3.00', '3.00', '9.00', '6.00', '0.00', '');

-- ----------------------------
-- Table structure for `htxtdjb`
-- ----------------------------
DROP TABLE IF EXISTS `htxtdjb`;
CREATE TABLE `htxtdjb` (
  `XH` varchar(36) NOT NULL,
  `NCBH` varchar(36) NOT NULL,
  `NZBH` varchar(36) NOT NULL,
  `XTRQ` datetime NOT NULL,
  `ZQ` int(1) NOT NULL DEFAULT '0',
  `YQ` int(1) NOT NULL DEFAULT '0',
  `ZH` int(1) NOT NULL DEFAULT '0',
  `YH` int(1) NOT NULL DEFAULT '0',
  `SY` varchar(36) NOT NULL,
  `BZ` text,
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of htxtdjb
-- ----------------------------
INSERT INTO `htxtdjb` VALUES ('d52510ea-cafd-4707-a445-b78e7cd84f45', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2015-05-13 00:00:00', '1', '0', '0', '0', '张三、李四', '');
INSERT INTO `htxtdjb` VALUES ('e155dccc-d54d-4dcc-ab86-8381ad651ffb', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2015-05-24 09:03:00', '0', '0', '1', '1', '张三', '这里是备注');
...
INSERT INTO `jbdjb` VALUES ('2f63dfc4-9dda-497d-98c4-0a95136c3215', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'ec155fa0-2b05-46b1-91ed-eafa64af475c', null, '', '', '', '', '', '', '0', null, '0.00', '0', null, '张三、李四', '');
INSERT INTO `jbdjb` VALUES ('cb0cd462-bdce-457a-a954-4690e93c0ea0', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2015-05-24 09:03:00', '种类', '未知', '发烧', '着凉', '轻度', '吃药', '0', '2015-05-23 14:03:00', '123.00', '12', '2015-05-27 09:02:00', '李四', '这里是备注');
INSERT INTO `jbdjb` VALUES ('d00309f7-2a69-49db-8438-3719dde357b6', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2016-03-16 00:00:00', '1', '1', '1', '1', '1', '1', '1', '2016-04-01 00:00:00', '11.00', '1', '2016-03-31 00:00:00', '张三、李四、王五', '');
INSERT INTO `jbdjb` VALUES ('b8ead6f1-109f-438d-8e8e-734eccb5c4f8', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2016-03-18 00:00:00', '1', '1', '1', '1', '1', '1', '0', '2016-03-18 00:00:00', '1.00', '1', '2016-03-25 00:00:00', '张三', '');

-- ----------------------------
-- Table structure for `jbqxx`
-- ----------------------------
DROP TABLE IF EXISTS `jbqxx`;
CREATE TABLE `jbqxx` (
  `xh` varchar(36) NOT NULL,
  `jbqbh` varchar(64) NOT NULL,
  `ncbh` varchar(36) NOT NULL,
  `nzbh` varchar(36) DEFAULT NULL,
...
-- Records of jbqxx
-- ----------------------------
INSERT INTO `jbqxx` VALUES ('4f91d72b-fe90-4546-9d90-c1f1df9e2060', '123', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'ec155fa0-2b05-46b1-91ed-eafa64af475c', '2016-02-29 11:52:10', null);
...
INSERT INTO `jsxxb` VALUES ('6253c239-246c-42b4-bf76-98b0306c7bea', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '001', '测试圈舍1', '砖房', null);
INSERT INTO `jsxxb` VALUES ('bc9f073f-84c6-4d0e-9329-c392fc175622', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '002', '测试圈舍2', '砖房', null);
INSERT INTO `jsxxb` VALUES ('384ab2b2-4c77-4c30-927e-04dfec33281b', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '003', '测试圈舍3', '砖房', null);
INSERT INTO `jsxxb` VALUES ('a230a1f0-04bf-4d5b-9087-c194aaf70b3c', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '004', '测试圈舍4', '砖房', null);
INSERT INTO `jsxxb` VALUES ('c36bb175-2732-4569-b066-e0e71e756b88', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '005', '测试圈舍5', '砖房', null);
INSERT INTO `jsxxb` VALUES ('faada00f-166f-49cd-98bf-16126bfa5f19', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '006', '测试圈舍6', '砖房', null);

-- ----------------------------
-- Table structure for `jydjb`
-- ----------------------------
DROP TABLE IF EXISTS `jydjb`;
CREATE TABLE `jydjb` (
  `XH` varchar(36) NOT NULL,
  `NCBH` varchar(36) NOT NULL,
  `NZBH` varchar(36) NOT NULL,
  `JYRQ` datetime NOT NULL,
  `JYYL` int(11) NOT NULL,
  `JYXM` varchar(500) DEFAULT NULL,
  `YMMC` varchar(500) DEFAULT NULL,
  `JYLX` varchar(100) DEFAULT NULL,
  `SYJL` varchar(500) DEFAULT NULL,
  `PH` varchar(100) DEFAULT NULL,
  `ZZS` varchar(100) DEFAULT NULL,
  `JG` varchar(500) DEFAULT NULL,
  `SY` varchar(36) DEFAULT NULL,
  `BZ` text,
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of jydjb
-- ----------------------------
INSERT INTO `jydjb` VALUES ('9895614d-4e1c-4259-a54f-4cc7d16f3093', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2015-05-14 00:00:00', '0', '', '', '', '', '', '', '', '张三、李四', '');
INSERT INTO `jydjb` VALUES ('66d5d3dd-4e34-4d67-b832-890cd670414c', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2015-05-24 09:03:00', '23', '感冒', '抗感冒', '日常', '100ml', '第一批', '北京生物', '良好', '张三', '这里是备注');
...
CREATE TABLE `lcdjb` (
  ...
  `BZ` varchar(128) DEFAULT NULL,
  `SJZT` int(11) NOT NULL DEFAULT '0' COMMENT '数据状态',
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of lcdjb
-- ----------------------------
INSERT INTO `lcdjb` VALUES ('eccf6740-f7ee-4932-80ce-d1a1555d2ae3', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'ec155fa0-2b05-46b1-91ed-eafa64af475c', '2016-03-17 00:00:00', '1', '1', 'b9a2f96b-7df7-47f2-8d2f-b0952008784d', '11', 'b9a2f96b-7df7-47f2-8d2f-b0952008784d', '李四', '', '0');

-- ----------------------------
-- Table structure for `mydjb`
-- ----------------------------
DROP TABLE IF EXISTS `mydjb`;
CREATE TABLE `mydjb` (
  `XH` varchar(36) NOT NULL COMMENT '序号',
  `NCBH` varchar(36) NOT NULL COMMENT '牛场编号',
  `NZBH` varchar(36) NOT NULL COMMENT '牛只编号',
  `MYRQ` datetime NOT NULL COMMENT '免疫日期',
  `MYXM` varchar(500) NOT NULL COMMENT '免疫项目',
  `YMMC` varchar(500) NOT NULL COMMENT '疫苗名称',
  `SYJL` varchar(500) NOT NULL COMMENT '使用剂量',
  `PH` varchar(100) DEFAULT NULL COMMENT '批号',
  `ZZS` varchar(100) DEFAULT NULL COMMENT '制造商',
  `JG` varchar(100) DEFAULT NULL COMMENT '结果',
  `SY` varchar(36) DEFAULT NULL COMMENT '兽医',
  `BZ` text,
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of mydjb
-- ----------------------------
INSERT INTO `mydjb` VALUES ('2feb4e93-8274-4be6-abdc-b5c8b04dbaa8', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2015-05-14 00:00:00', '', '', '', '', '', '', '张三、李四、王五', '');
INSERT INTO `mydjb` VALUES ('3a355d97-2f47-471d-b994-18f165a88c56', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2015-05-24 09:03:00', '1.0', '20.0', '100ml', '第一批', '北京生物', '良好', '张三', '这里是备注');
...
-- ----------------------------
-- Table structure for `nctjxx`
-- ----------------------------
DROP TABLE IF EXISTS `nctjxx`;
CREATE TABLE `nctjxx` (
  `ncxh` varchar(36) NOT NULL,
  `zts` int(11) NOT NULL DEFAULT '0' COMMENT '总头数',
  `fq30` int(11) NOT NULL DEFAULT '0' COMMENT '发情30天',
  `fq30jcl` double NOT NULL DEFAULT '0' COMMENT '发情30天检出率',
  `fq1` int(11) NOT NULL DEFAULT '0' COMMENT '当天发情',
  `fq1jcl` double NOT NULL DEFAULT '0',
  `fq0t` datetime DEFAULT NULL COMMENT '最后发情时间',
  `cd30` int(11) NOT NULL DEFAULT '0',
  `cpl30` double NOT NULL DEFAULT '0',
  `cnz` double NOT NULL DEFAULT '0',
  `cn1num` varchar(36) DEFAULT NULL,
  `cn1value` double NOT NULL DEFAULT '0',
  PRIMARY KEY (`ncxh`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of nctjxx
-- ----------------------------
INSERT INTO `nctjxx` VALUES ('d81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '3', '0', '0', '0', '0', '2015-12-21 21:38:12', '2', '800', '10', null, '5');

-- ----------------------------
-- Table structure for `nzfzztxx`
-- ----------------------------
...
CREATE TABLE `nzfzztxx` (
  ...
  `bj` int(1) NOT NULL DEFAULT '0' COMMENT '0 已发情 1 已初检 2 已复检',
...
-- Records of nzfzztxx
-- ----------------------------
INSERT INTO `nzfzztxx` VALUES ('b320a5dc-4c5c-4201-8721-33ba44616038', '2016-03-22 01:00:00', '2016-03-22 09:00:00', '0', '0', '49ded95b-3e50-4d3a-8670-2b7263b4273d', '0', '0', 'ec155fa0-2b05-46b1-91ed-eafa64af475c');
INSERT INTO `nzfzztxx` VALUES ('1c40665d-4423-4c4f-a4fd-60b604031147', '2016-04-08 16:19:21', '2017-01-13 16:19:21', '1', '0', 'eaf41203-846e-4c57-89f3-69c5e6c68604', '1', '0', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d');
...
CREATE TABLE `nzjbxx` (
  ...
  `FZZT` int(1) NOT NULL DEFAULT '-1',
  `NZZT` int(1) NOT NULL DEFAULT '-1',
  `QQ` int(2) NOT NULL DEFAULT '0' COMMENT '发情情期',
  `ZHPZRQ` datetime DEFAULT NULL COMMENT '最后发情日期',
  `PYTS` int(11) DEFAULT '-1',
  `TJJ` int(11) DEFAULT '-1',
  `BZ` varchar(128) DEFAULT NULL,
  `fzztxh` varchar(36) DEFAULT NULL,
  `mrztxh` varchar(36) DEFAULT NULL,
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of nzjbxx
-- ----------------------------
INSERT INTO `nzjbxx` VALUES ('77b80d7c-cc60-4a0e-9208-980d65cd0cf9', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'NZ00001', '1', '1', '2015-05-08 00:00:00', '0', '1', '1', null, '0.00', '11.00', 'a5f61758-61c9-45a1-afa2-d6f00e987d9e', '11', '1', '1', '2015-05-06 00:00:00', '1', '1', '-1', '-1', '1', '1', null, '-1', '-1', '', null, null);
INSERT INTO `nzjbxx` VALUES ('67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '001', '', '', '2015-01-01 00:00:00', '0', '5', '0', '2015-01-01 00:00:00', '0.00', '1.00', 'ce9deded-6bdd-44dc-8c21-c5e346bbdd0c', '1', '1', '3', '2015-05-27 00:00:00', '1', '1', '-1', '-1', '0', '0', null, '-1', '-1', '', null, null);
INSERT INTO `nzjbxx` VALUES ('ec155fa0-2b05-46b1-91ed-eafa64af475c', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '012', '', '', '2015-05-22 00:00:00', '0', '3', '0', '2015-05-22 00:00:00', '0.00', '1.00', 'ce9deded-6bdd-44dc-8c21-c5e346bbdd0c', '1', '1', '1', null, '', '', '-1', '-1', '0', '4', null, '-1', '-1', '', 'b320a5dc-4c5c-4201-8721-33ba44616038', null);
INSERT INTO `nzjbxx` VALUES ('cb07fd07-4be8-4668-9bfb-8a11553c0e7d', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'DR001', '', '', '2014-01-01 00:00:00', '0', '5', '0', '2014-01-01 00:00:00', '24.00', '12.00', 'a5f61758-61c9-45a1-afa2-d6f00e987d9e', '优', '白色', '1', '2015-05-02 00:00:00', '', '', '-1', '-1', '0', '1', null, '10', '-1', '', '1c40665d-4423-4c4f-a4fd-60b604031147', null);
INSERT INTO `nzjbxx` VALUES ('adee8481-dc19-43cf-8e20-3d4f140af59e', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'T001', '', '', '2014-01-02 00:00:00', '0', '4', '0', '2014-01-02 00:00:00', '17.00', '1.00', 'ce9deded-6bdd-44dc-8c21-c5e346bbdd0c', '1', '1', '0', null, '', '', '-1', '-1', '2', '2', null, '-1', '-1', '', null, null);
...
-- ----------------------------
-- Table structure for `nzttjdb`
-- ----------------------------
DROP TABLE IF EXISTS `nzttjdb`;
CREATE TABLE `nzttjdb` (
  `xh` varchar(36) NOT NULL,
  `ncbh` varchar(36) NOT NULL,
  `nzxh` varchar(36) NOT NULL,
  `ttrq` datetime NOT NULL,
  `ttyy` text,
  `jsr` text,
  `bz` text,
  PRIMARY KEY (`xh`)
...
-- Records of nzttjdb
-- ----------------------------
INSERT INTO `nzttjdb` VALUES ('f9cdb299-f79e-4103-96e4-f7fa0827d2dc', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'adee8481-dc19-43cf-8e20-3d4f140af59e', '2015-07-15 00:00:00', '111', '张三', '11');
...
-- Records of nzzsdjb
-- ----------------------------
INSERT INTO `nzzsdjb` VALUES ('9ef54635-ec96-44e6-8915-6e0da23720e0', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '77b80d7c-cc60-4a0e-9208-980d65cd0cf9', '2015-05-09 00:00:00', 'ce9deded-6bdd-44dc-8c21-c5e346bbdd0c', 'a5f61758-61c9-45a1-afa2-d6f00e987d9e', '王五', '');
...
CREATE TABLE `pzdjb` (
  ...
  `BZ` varchar(128) DEFAULT NULL,
  `SJZT` int(1) NOT NULL DEFAULT '0' COMMENT '数据状态',
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of pzdjb
-- ----------------------------
INSERT INTO `pzdjb` VALUES ('eaf41203-846e-4c57-89f3-69c5e6c68604', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2016-04-08 16:19:21', '11', '1111', '张三', '2016-04-06 16:16:58', '0', '0', '张三', '0', '', '0');

-- ----------------------------
-- Table structure for `qcdjb`
-- ----------------------------
DROP TABLE IF EXISTS `qcdjb`;
CREATE TABLE `qcdjb` (
  `XH` varchar(36) NOT NULL,
  `NCBH` varchar(36) NOT NULL,
  `NZBH` varchar(36) NOT NULL,
  `QCRQ` datetime NOT NULL,
  `QCFF` varchar(500) NOT NULL,
  `YWMC` varchar(500) NOT NULL,
  `SYJL` varchar(500) NOT NULL,
  `ZZS` varchar(100) NOT NULL,
  `PH` varchar(100) NOT NULL,
  `QCXG` varchar(500) NOT NULL,
  `SY` varchar(36) NOT NULL,
  `BZ` text,
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of qcdjb
-- ----------------------------
INSERT INTO `qcdjb` VALUES ('43ecce76-f399-41db-835e-586fade26901', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '67737e1f-6a88-4b4c-a5b6-e3d2faff9b7c', '2015-05-14 00:00:00', '', '', '', '', '', '', '张三、王五', '');
INSERT INTO `qcdjb` VALUES ('530c369b-b69f-482a-9fe9-c76acedcb210', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2015-05-24 09:03:00', '喷药', '杀小虫', '100ml', '北京生物', '第一批', '良好', '张三', '这里是备注');
...
CREATE TABLE `rjcjdjb` (
  ...
  `CJJG` int(2) NOT NULL DEFAULT '-1',
  `CJY` varchar(100) NOT NULL,
  `CJFS` int(2) NOT NULL,
  `RJ2RQ` datetime DEFAULT NULL COMMENT '妊检2日期',
  `RJ2JG` int(2) DEFAULT '-1' COMMENT '妊检2结果',
  `RJ3RQ` datetime DEFAULT NULL COMMENT '妊检3日期',
  `RJ3JG` int(11) DEFAULT '-1' COMMENT '妊检3结果',
  `BZ` text,
  `SJZT` int(11) NOT NULL DEFAULT '0' COMMENT '数据状态',
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- Records of rjcjdjb
-- ----------------------------
INSERT INTO `rjcjdjb` VALUES ('0df2cc0a-4ffe-4260-97c9-2b355d03e9ea', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2016-04-18 00:00:00', '0', '张三', '0', null, '-1', null, '-1', '', '0');
INSERT INTO `rjcjdjb` VALUES ('d7c3e25a-2332-4802-9448-69725c5143ed', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', 'cb07fd07-4be8-4668-9bfb-8a11553c0e7d', '2016-04-18 00:00:00', '0', '张三', '0', null, '-1', null, '-1', '', '0');
...
-- ----------------------------
-- Table structure for `tsxxb`
-- ----------------------------
DROP TABLE IF EXISTS `tsxxb`;
CREATE TABLE `tsxxb` (
  `XH` varchar(36) NOT NULL,
  `NCBH` varchar(36) DEFAULT NULL,
  `SJHM` varchar(36) DEFAULT NULL,
  `TSLX` varchar(36) DEFAULT NULL COMMENT '包括发情提示、最佳配种时间提示、运动量下降提示、定胎提示等',
  `TSNR` varchar(128) DEFAULT NULL COMMENT '提示内容',
  `SFTS` char(1) DEFAULT '1' COMMENT '0：否\r\n            1：是',
  `YFDX` char(1) DEFAULT '0',
  `BZ` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`XH`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
DROP TABLE IF EXISTS `xddjb`;
CREATE TABLE `xddjb` (
  `XH` varchar(36) NOT NULL,
  `NCBH` varchar(36) NOT NULL,
  `XDRQ` datetime NOT NULL,
  `XDQY` varchar(500) NOT NULL,
  `YJMC` varchar(500) NOT NULL,
  `SYJL` varchar(500) NOT NULL,
  `ZZS` varchar(100) NOT NULL,
  `PH` varchar(100) NOT NULL,
  `SY` varchar(36) NOT NULL,
...
-- Records of xddjb
-- ----------------------------
INSERT INTO `xddjb` VALUES ('ef59487e-0f52-4187-95e9-1312e1f80bc8', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '2015-05-14 00:00:00', '', '', '', '', '', '张三、李四', '');
INSERT INTO `xddjb` VALUES ('3b1ceb21-ddbc-4bfe-9e61-0fc2f457f59f', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '2015-05-24 09:03:00', '东区', '消毒', '100ml', '北京生物', '第一批', '张三', '这里是备注');
...
INSERT INTO `ygxxb` VALUES ('0c06daaf-0507-4c26-841a-468f6f678978', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '001', '导入员工1', '100001', '123456789', '北京市房山区', '饲养员', '0', null);
INSERT INTO `ygxxb` VALUES ('73143c0c-03f9-40e7-9e26-5c275d6c12cc', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '002', '导入员工2', '100002', '123456789', '北京市房山区', '兽医', '0', null);
INSERT INTO `ygxxb` VALUES ('e11a4b4a-e939-4523-b17c-c0736af6a66f', 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e', '003', '导入员工3', '100003', '123456789', '北京市房山区', '饲养员', '0', null);
...
INSERT INTO `yh_system_config` VALUES ('1bc2e661-1693-48a1-b841-be5f1070807c', '_DM_KZQPZ_', 'SHANGXIAN', '30', null, 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e');
INSERT INTO `yh_system_config` VALUES ('49c6eec4-95d9-4cbd-84d2-a00f422b5273', '_DM_KZQPZ_', 'XIAXIAN', '10', null, 'd81ffad1-e0ef-495f-9fdc-acdbb2fb935e');
...
INSERT INTO `yh_system_menus` VALUES ('54af0c61-e2ba-4216-8281-da5e14bcf9fe', '我的牛场信息', null, '/admin/pages/ncgl/me.jsp', '0', '1', '1b9139be-09af-4667-a634-98dc61906543', '2', '1');
INSERT INTO `yh_system_menus` VALUES ('8c3ed385-cc3c-4416-a6ce-9043bf8fe844', '圈舍信息管理', null, '/master/jsgl/jsgl.action', '0', '1', '1b9139be-09af-4667-a634-98dc61906543', '4', '1');
...
INSERT INTO `yh_system_menus` VALUES ('af0a7e33-4e07-4fed-972a-c798616766cb', '妊检记录登记', null, '/master/fzgl/rjcj.action', '0', '1', '60ae96d5-72a9-4d58-bbe3-1166252529ce', '2', '1');
...
INSERT INTO `yh_system_menus` VALUES ('5e498a89-cc2c-4e2d-b8f1-16ecbcdd24e2', '疾病登记', null, '/master/jbfy/jbxx.action', '0', '1', 'f2ef60df-3c0d-479c-a3ea-abe162e749e9', '0', '1');
...
INSERT INTO `yh_system_menus` VALUES ('4cd2f1a6-8328-4c73-b85f-99cb7da45dec', '计步器信息管理', null, '/master/fqxt/jbq.action', '0', '1', '6d07a593-4daa-43ea-9ee5-12be440bce2f', '2', '1');
INSERT INTO `yh_system_menus` VALUES ('55277b6d-594a-41f1-a625-783d89c651b9', '淘汰记录查询', null, '/master/nzgl/ttxx.action', '0', '1', 'b953f0d0-a0f3-462b-9726-bc72012ac760', '3', '1');
...
INSERT INTO `yh_system_menus` VALUES ('6dd6b862-cb5b-4fe8-becd-f79a7053f08f', '牛群概貌', null, '/master/index.action', '0', '1', '1b9139be-09af-4667-a634-98dc61906543', '1', '1');
...
INSERT INTO `yh_system_menus` VALUES ('8be65c7c-2ad4-4e23-a514-bf67cd957960', '检疫登记', null, '/master/jbfy/jyxx.action', '0', '1', 'f2ef60df-3c0d-479c-a3ea-abe162e749e9', '2', '1');
...
INSERT INTO `yh_system_menus` VALUES ('1c145da7-cc01-4062-b742-d4ef7a2406ec', '统计', null, '/master/jcsj/tongji.action', '0', '1', '1b9139be-09af-4667-a634-98dc61906543', '0', '1');
INSERT INTO `yh_system_menus` VALUES ('9bdf83cd-6645-462d-8c81-29661667ad4f', '控制器设置', null, '/master/fqxt/kzqpz.action', '0', '1', '6d07a593-4daa-43ea-9ee5-12be440bce2f', '3', '1');
...
INSERT INTO `yh_system_roles` VALUES ('b05f9a5d-10c7-466f-833a-3ab9928fefae', '企业用户', null, '1c145da7-cc01-4062-b742-d4ef7a2406ec,6dd6b862-cb5b-4fe8-becd-f79a7053f08f,54af0c61-e2ba-4216-8281-da5e14bcf9fe,979e846b-a625-4ff4-bdb4-cac85c4d6133,8c3ed385-cc3c-4416-a6ce-9043bf8fe844,b953f0d0-a0f3-462b-9726-bc72012ac760,6d07a593-4daa-43ea-9ee5-12be440bce2f,a98aa967-38b2-45b4-bb13-7ef21badad0f,d41d97c3-3d88-412e-9d46-f59a19d0e5fa,af0a7e33-4e07-4fed-972a-c798616766cb,31013884-4db1-46e8-a3af-42c106d156d1,48a6b0a6-94fe-40b1-b0bc-1819025b386b,a65b21f6-492e-437c-bd16-e32b7353765b,352fa9a5-17d5-4d79-82db-6b392bdad1e3,f2ef60df-3c0d-479c-a3ea-abe162e749e9,13a74fbb-d638-4d88-94c3-d92f71b5b831', '0', null, '2', '0');
...
INSERT INTO `yh_system_users` VALUES ('f0482464-454d-4a44-b008-dbae061d298a', 'qiye1', 'qiye1', '23134a96830f81f749cad6af6f1eade4e207c845e061153c3885f88cf572dec8', null, '0', 'b05f9a5d-10c7-466f-833a-3ab9928fefae', null, '2016-04-18 17:04:22', '2016-04-18 17:07:40');
...
-- ----------------------------
-- Procedure structure for `SP_OF_TR_get_pjbs`
-- ----------------------------
...
-- ----------------------------
-- Procedure structure for `SP_OF_TR_ins_ydsj`
-- ----------------------------
...
-- ----------------------------
-- Procedure structure for `SP_OF_TR_ins_ydts`
-- ----------------------------
...
DELIMITER ;;
CREATE TRIGGER `TG_INSERT_FQJBXX` AFTER INSERT ON `fqjbxx` FOR EACH ROW BEGIN
