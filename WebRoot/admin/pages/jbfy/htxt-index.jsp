...
<body>
	<div class="box">
		<div class="box_border">
			...
			<div class="box_center pt5 pb5">
				<form id="frmSearch"
					action="${pageContext.request.contextPath}/master/jbfy/htxtxx.action"
					method="post">
	...
	<div class="box span10 oh mt5">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<s:iterator value="htlist" status="status" id="htxx">
				<tr>
					<td>${status.count }</td>
					...
					<td><a title="修改"
						...
						url="${pageContext.request.contextPath}/master/jbfy/htxtxx!delete.action?id=<s:property value="#htxx.xh"/>"
					...
					<i:Page page="pager" count="9">
						...
						<s:else>
							<li class="first-child"><a
								href="${pageContext.request.contextPath}/master/jbfy/jbxx.action?p=${pageNowNum-1}${searchString}">上一页</a></li>
						</s:else>
						<i:PageNum>
							...
							<s:else>
								<li><a
									href="${pageContext.request.contextPath}/master/jbfy/jbxx.action?p=${pageIndex}${searchString}">${pageIndex}</a></li>
							</s:else>
						</i:PageNum>
						...
						<s:else>
							<li><a class=""
								href="${pageContext.request.contextPath}/master/jbfy/jbxx.action?p=${pageNowNum+1}${searchString}">下一页</a></li>
						</s:else>
	...
	<script type="text/javascript">
     	...
     	function add()
     	{
     		window.location.href="${pageContext.request.contextPath}/admin/pages/jbfy/htxt-add.jsp";
     	}
     	
     	function edit(id)
     	{
     		window.location.href="${pageContext.request.contextPath}/master/jbfy/htxtxx!edit.action?id="+id;
     	}
