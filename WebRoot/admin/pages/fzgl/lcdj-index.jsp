  	...
  	<div class="box">
	  		<div class="box_border">
	        	<div class="box_top">
	          	...
	          	<div class="box_center pt5 pb5">
	          		<form id="frmSearch" action="${pageContext.request.contextPath}/master/fzgl/lcdj.action" method="post">
	         ...
	         <div class="pb5 pt5 pr10">
	          		<div class="search_bar_btn" style="text-align:right;">
	          			...
	          			<input type="button" name="button" data="11" onClick="dataExport()" class="btn btn82 btn_export" value="导出">
	          		</div>
	         </div>
	 </div>
         	...
         	<div class="pagination">
            	<ul>
            		<i:Page page="pager" count="9">
						...
						<s:else>
							<li class="first-child"><a href="${pageContext.request.contextPath}/master/fzgl/lcdj.action?p=${pageNowNum-1}${searchString}">上一页</a></li>
						</s:else>
						<i:PageNum>
							...
							<s:else>
								<li><a href="${pageContext.request.contextPath}/master/fzgl/lcdj.action?p=${pageIndex}${searchString}">${pageIndex}</a></li>
							</s:else>
						</i:PageNum>
						...
						<s:else>
							<li><a class="" href="${pageContext.request.contextPath}/master/fzgl/lcdj.action?p=${pageNowNum+1}${searchString}">下一页</a></li>
						</s:else>
