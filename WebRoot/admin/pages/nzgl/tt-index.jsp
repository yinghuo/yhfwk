  	...
  	<div class="box span10 oh mt5">
  	 	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table ta-c">
  	 		<tr>
              	...
              	<th width="200">淘汰日期</th>
              	<th width="200">淘汰原因</th>
              	<th width="200">经手人</th>
         	</tr>
         	<s:iterator value="ttlist" status="status" id="ttxx">
				<tr>
					<td><s:property value="#ttxx.nzjbxx.nzbh"/></td>
					<td><s:property value="#ttxx.nzjbxx.jsjbxx.jsbh"/></td>
					<td><s:date name="#ttxx.ttrq" format="yyyy-MM-dd HH:mm"/></td>
					<td><s:property value="#ttxx.ttyy"/></td>
					<td><s:property value="#ttxx.jsr"/></td>
				</tr>
			</s:iterator>
  	 	</table>
