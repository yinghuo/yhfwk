		         	...
		         	<div class="pagination">
		            	<ul>
		            		<i:Page page="pager" count="9">
								...
								<s:else>
									<li class="first-child"><a href="${pageContext.request.contextPath}/master/yggl/yggl.action?p=${pageNowNum-1}${searchString}">上一页</a></li>
								</s:else>
								<i:PageNum>
									...
									<s:else>
										<li><a href="${pageContext.request.contextPath}/master/yggl/yggl.action?p=${pageIndex}${searchString}">${pageIndex}</a></li>
									</s:else>
								</i:PageNum>
								...
								<s:else>
									<li><a class="" href="${pageContext.request.contextPath}/master/yggl/yggl.action?p=${pageNowNum+1}${searchString}">下一页</a></li>
								</s:else>
